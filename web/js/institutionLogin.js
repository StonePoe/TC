...
function instiRegisterWithCheck() {
    console.log(instiName.value);
    ...
    setTimeout(function () {
        if(password.value != confirmPs.value) {
            ...
            $.ajax({
                type: 'post',
                url: '/institution/register/info',
                data: 'instiName=' + instiName.value + "&password=" + password.value,
