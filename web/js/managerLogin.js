...
function managerRegisterWithCheck() {
    ...
    setTimeout(function () {
        if(password.value != confirmPs.value) {
            ...
            $.ajax({
                type: 'post',
                url: '/admin/register/info',
                data: 'manager=' + managerName.value + "&password=" + password.value,
...
function managerLoginWithCheck() {
    console.log(managerName.value);
    console.log(password.value);
    document.querySelector(".error-login").className = "control-label error-name d_none";
    // document.querySelector(".error-ps").className = "control-label error-ps d_none";
    ...
    setTimeout(function () {
        $.ajax({
            ...
            data: 'managerName=' + managerName.value + "&password=" + password.value,
            // success: function (url) {
            //     if(url != null) {
            //         // window.location.reload();
            //         window.location.href = url;
            ...
            success: function (data) {
                if(data.success == true) {
                    ...
                    document.querySelector(".error-name").className = "control-label error-login";
                }
            },
            error: function () {
                alert('network error !!!!!!!!!!!!');
