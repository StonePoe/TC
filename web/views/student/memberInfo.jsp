    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                <li class="active"><a href="/student/member"><i class="fa fa-circle-o"></i>会员状态</a></li>
            ...
            <div class="box-body">
                ...
                <div class="row margin-bottom">
                    <div class="col-sm-6">
                        <p class="lead">激活须知</p>
                        <br>
                        <p class="text-muted">请保证您绑定的银行卡至少有1000元余额</p>
                        <p class="text-muted">需要一次性存入1000元到会员卡才可进行激活</p>
                    </div>
                    <div class="col-sm-6">
                        <p class="lead">您的银行卡余额</p>
                        <%if(bankcardVO.getBalance() >= 1000){%>
                        <label style="color: #00a157"><i class="fa-check-circle"></i>可以激活</label>
                        <input style="display: none" value="<%=bankcardVO.getId()%>" id="bankid">
                        <input style="display: none" value="<%=memberCardVO.getId()%>" id="memberid">

                        <br>
                        <div>
                            <button type="button" class="btn btn-block btn-warning btn-sm"
                            onclick="activeMember()">激活</button>
                        </div>
                        <%} else {%>
                        <label style="color: #e47365"><i class="fa-times-circle"></i>不足以激活</label>
                        <%}%>
                    </div>
                    <!-- /.col -->
                </div>
...
<script src="../../js/studentmember.js"></script>
</body>
</html>
