    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a onclick="showBasic()"><i class="fa fa-circle-o"></i>基本信息</a></li>
                <li><a onclick="showSecurity()"><i class="fa fa-circle-o"></i>安全管理</a></li>
                <li><a onclick="showFinance()"><i class="fa fa-circle-o"></i>资金管理</a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
                    ...
                    <div class="box-body">
                        <div class="form-group nameGroup">
                            ...
                            <input type="text" class="form-control inputName" id="inputName"
                                   placeholder="<%=institutionInfoVO.getName()%>">
            ...
            <div class="box box-solid">
                ...
                <form role="form">
                    <div class="box-body psGroup">
                        ...
                        <p class="text-muted">余额: <%=institutionInfoVO.getBalance()%></p>
                    </div>
                    <!-- /.box-body -->
...
<script src="../../js/institutionInfo.js"></script>
</body>
</html>
