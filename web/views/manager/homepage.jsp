    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="/admin/homepage"><i class="fa fa-circle-o"></i>课程审批</a></li>
                <li><a href="/admin/finance"><i class="fa fa-circle-o"></i>资金审批</a></li>
                        ...
                        <div class="col-sm-12">
                            <table id="example2" class="table table-bordered table-hover dataTable"
                                ...
                                <tr role="row">
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="起止时间: activate to sort column ascending">
                                        起止时间
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                    ...
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="申请时间: activate to sort column ascending">
                                        申请时间
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                ...
                                <c:forEach var="courseCheckVO" items="${uncheckReleaseList}">
                                    <tr onclick="">
                                        <td>
                                            ${courseCheckVO.name}
                                        </td>
                                        <td>
                                            ${courseCheckVO.insName}
                                        </td>
                                        <td>
                                            ${courseCheckVO.teacherName}
                                        </td>
                                        <td>
                                            ${courseCheckVO.fieldName}
                                        </td>
                                        <td>
                                            ${courseCheckVO.startdate} 到 ${courseCheckVO.enddate}
                                        </td>
                                        <td>
                                            ${courseCheckVO.price}
                                        </td>
                                        <td>
                                            ${courseCheckVO.releaseTime}
                                        </td>
                                        <td>
                                            <button type="button" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal${courseCheckVO.id}">
                                                审批
                                            </button>
                                            <div class="modal fade" id="myModal${courseCheckVO.id}" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                                                            <h4 class="modal-title" id="myModalLabel">${courseCheckVO.name}</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                <div class="col-sm-6">
                                                                    <img src="${courseCheckVO.imgUrl}" class="courseImg" alt="Product Image">
                                                                </div>
                                                                <div class="col-sm-6">
                                                                ${courseCheckVO.name}
                                                                    <br>
                                                                ...
                                                                ${courseCheckVO.releaseTime}
                                                                    <br>
                                                                ${courseCheckVO.description}
                                                                    <br>
                                                                    ${courseCheckVO.releaseTime}
                                                                    <br>
                                                                    <input placeholder="审批意见" id="comment${courseCheckVO.id}">
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary" onclick="agree(${courseCheckVO.id})">通过</button>
                                                            <button type="button" class="btn btn-primary" onclick="disagree(${courseCheckVO.id})">不通过</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example3" class="table table-bordered table-hover dataTable"
                                ...
                                <c:forEach var="courseCheckVO" items="${uncheckUpdateList}">
                                    <tr>
                                        <td>
                                                ${courseCheckVO.name}
                                        </td>
                                        <input style="display: none" value="${courseCheckVO.cid}"
                                               id="cid${courseCheckVO.id}">
                                        <input style="display: none" value="${courseCheckVO.name}"
                                               id="cname${courseCheckVO.id}">

                                        <input style="display: none" value="${courseCheckVO.courseUpdateId}"
                                               id="updateId${courseCheckVO.id}">
                                        <td>
                                                ${courseCheckVO.insName}
                                        </td>
                                        ...
                                        <input style="display: none" value="${courseCheckVO.description}"
                                               id="description${courseCheckVO.id}">
                                        <td>
                                                ${courseCheckVO.price}
                                        </td>
                                        <input style="display: none" value="${courseCheckVO.price}"
                                               id="price${courseCheckVO.id}">
                                        <td>
                                                ${courseCheckVO.releaseTime}
                                        </td>
                                        <td>
                                            <a onclick="agreeUpdate(${courseCheckVO.id})">通过</a>
                                            <a onclick="disagreeUpdate(${courseCheckVO.id})">不通过</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
...
<script src="../../js/managerCourse.js"></script>
</body>
</html>
