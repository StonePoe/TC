    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="/admin/info"><i class="fa fa-circle-o"></i>信息修改</a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
                ...
                <form role="form">
                    <div class="box-body">
                        <div class="form-group nameGroup">
                            <span>新的名字</span>
                            <input type="text" class="form-control inputName" id="inputName" placeholder="<%=managerInfoVO.getName()%>">
...
<script src="../../js/managerInfo.js"></script>
</body>
</html>
