...
public class InstitutionVOManagerImpl implements InstitutionVOManager{
    ...
    @Override
    public List<InstitutionCourseStatisticsVO> getInstiStatistics(int insid) {
        List<InstitutionCourseStatistics> institutionCourseStatisticsList =
                institutionCourseStatisticsDAO.selectByInsti(insid);
        ...
        System.out.println("from institutionVOManager: " + result);
        return result;
    }
}
