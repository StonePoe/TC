        ...
        <div class="cont_centrar">
            <div class="cont_login">
                <div class="cont_tabs_login">
                    <ul class='ul_tabs'>
                        <li class="active"><a onclick="sign_in()">经理登录</a>
                            <span class="linea_bajo_nom"></span>
                        </li>
                        <li><a onclick="sign_up()">经理注册</a>
                            <span class="linea_bajo_nom"></span>
                        </li>
                    </ul>
                </div>
                ...
                <div class="cont_text_inputs">
                    <input type="text" class="input_form_sign d_block active_inp"
                           placeholder="经理名" id="managerName" name="name" />
                    <label class="control-label error error-name d_none" for="managerName">
                ...
                <div class="cont_btn">
                    <button class="btn_sign_in btn_sign" onclick="managerLoginWithCheck()">登录</button>
                </div>
                <div class="cont_btn">
                    <button class="btn_sign_up btn_sign" type="button" style="display: none" onclick="managerRegisterWithCheck()">注册</button>
                </div>
            </div>
