...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="active"><a href="/admin/log"><i class="fa fa-circle-o"></i>记录查看</a></li>
    ...
    <div class="content-wrapper">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example2" class="table table-bordered table-hover dataTable"
                                ...
                                <c:forEach var="activityLogVO" items="${courseFinances}">
                                    <tr onclick="">
                                        <td>
                                                ${activityLogVO.sname}
                                        </td>
                                        ...
                                        <td>
                                            ${activityLogVO.behaviour}
                                        </td>
                                        <td>
                                                ${activityLogVO.description}
                                        </td>
                                        <td>
                                                ${activityLogVO.modifyTime}
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example3" class="table table-bordered table-hover dataTable"
                                ...
                                <c:forEach var="activityLogVO" items="${otherFinances}">
                                    <tr onclick="">
                                        <td>
                                                ${activityLogVO.money}
                                        </td>
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">学生记录</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
                <div id="example4_wrapper" class="classdataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-6"></div>
                        <div class="col-sm-6"></div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example4" class="table table-bordered table-hover dataTable"
                                ...
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="学生ID: activate to sort column ascending">
                                        学生ID
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="类别: activate to sort column ascending">
                                ...
                                <c:forEach var="activityLogVO" items="${studentLogs}">
                                    <tr onclick="">
                                        <td>
                                                ${activityLogVO.sid}
                                        </td>
        ...
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">机构记录</h3>
            </div>
        <!-- /.box-header -->
            <div class="box-body">
                <div id="example5_wrapper" class="classdataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-6"></div>
                        <div class="col-sm-6"></div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example5" class="table table-bordered table-hover dataTable"
                                   role="grid" aria-describedby="example5_info">
                                <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="机构ID: activate to sort column ascending">
                                        机构ID
                                    </th>
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="类别: activate to sort column ascending">
                                ...
                                <c:forEach var="activityLogVO" items="${institutionLogs}">
                                    <tr onclick="">
                                        <td>
                                                ${activityLogVO.insid}
                                        </td>
        ...
        <div class="box">
            ...
            <div class="box-body">
                <div id="example6_wrapper" class="classdataTables_wrapper form-inline dt-bootstrap">
                    <div class="row">
                        <div class="col-sm-6"></div>
                        <div class="col-sm-6"></div>
                    </div>
                    <div class="row">
                        <div class="col-sm-12">
                            <table id="example6" class="table table-bordered table-hover dataTable"
                                   role="grid" aria-describedby="example6_info">
                                <thead>
                                <tr role="row">
                                    <th class="sorting" tabindex="0" aria-controls="example2" rowspan="1" colspan="1"
                                        aria-label="课程: activate to sort column ascending">
