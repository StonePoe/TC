    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li><a href="/student/log"><i class="fa fa-circle-o"></i>选课记录</a></li>
                <li class="active"><a href="/student/studentLog"><i class="fa fa-circle-o"></i>学生动态</a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
