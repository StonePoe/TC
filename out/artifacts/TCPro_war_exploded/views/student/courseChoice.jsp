...
<%@ page import="tc.model.Course" %>
<%@ page import="java.util.List" %>
<%@ page import="java.util.Map" %>
<%@ page contentType="text/html;charset=UTF-8" language="java" %>
<%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
<% Map<String, List<StudentCourseVO>> studentCourseVOList = (Map<String, List<StudentCourseVO>>)request.getAttribute("studentCourseVOList");%>
...
<c:forEach var="studentCourseVO" items="<%= studentCourseVOList %>">
  <div class="box box-solid">
   <div class="box-header with-border">
    <h3 class="box-title"><c:out value="${studentCourseVO.key}"/></h3>
   ...
   <div class="box-body">
    <ul class="products-list product-list-in-box">
     <c:forEach var="courseDetail" items="${studentCourseVO.value}">
         <li class="item">
             <div class="product-img">
                 <img src="<c:out value="${courseDetail.getImg()}"/>" class="courseImg" alt="Product Image">
             </div>
             <div class="product-info">
                 <a href="/student/course?cid=<c:out value="${courseDetail.getId()}"/>" class="product-title">
                     <c:out value="${courseDetail.getName()}"/>
                     <span class="label label-warning pull-right">¥<c:out value="${courseDetail.getPrice()}"/></span></a>
                 <span class="product-description">
                         <c:out value="${courseDetail.getDescription()}"/>
                        </span>
             </div>
         </li>
     </c:forEach>
