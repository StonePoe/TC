...
<head>
    ...
    <link rel="stylesheet" href="../../plugin/croppie/croppie.css">
...
<div class="wrapper">
    ...
    <aside class="main-sidebar">
        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu">
                ...
                <li class="basicLink active"><a onclick="showBaisc()"><i class="fa fa-circle-o"></i>基本信息</a></li>
                <li class="securityLink"><a onclick="showSecurity()"><i class="fa fa-circle-o"></i>账号安全</a></li>
                <li class="bankLink"><a onclick="showBank()"><i class="fa fa-circle-o"></i>银行信息</a></li>
            </ul>
        </section>
        <!-- /.sidebar -->
    </aside>
    ...
    <div class="content-wrapper">
            ...
            <div class="box box-solid">
                ...
                <form role="form">
                    <div class="box-body">
                        ...
                        <img class="img-bordered d-none" alt="Image Previewer" id="previewer">
        ...
        <div class="securityInfo" style="display: none;">
            <div class="box box-solid">
                <!-- /.box-header -->
                <!-- form start -->
                <form role="form">
                    <div class="box-body psGroup">
                        ...
                        <div class="form-group psGroup">
                            <span>重复一遍</span>
                            <input type="password" id="confirmPs" class="form-control confirmPs">
                            <label class="control-label error-ps d-none" for="confirmPs">
...
<script src="../../plugin/croppie/croppie.js"></script>

<script src="../../js/studentInfo.js"></script>

<script src="../../js/nameInspection.js"></script>
</body>
</html>
